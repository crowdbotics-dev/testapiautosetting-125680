...
## Project Structure
    ...
    ├── testapiautosetting_125680  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125680`
...
2. Clone this repo and `cd testapiautosetting_125680`
